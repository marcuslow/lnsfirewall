#!/usr/bin/env python3
"""Simple test to check if AI Command Center can query logs"""
import asyncio
import os
import sys
...
async def test():
    print("=" * 80)
    print("Testing AI Command Center - Simple Query")
    print("=" * 80)
    ...
    try:
        response = await ai_center.chat_with_ai("What is the status of opus-1?")
        print(f"\n{'=' * 80}")
        print("RESPONSE:")
        print(f"{'=' * 80}")
        print(response)
